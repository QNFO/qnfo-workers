...
// reading.q08.org/p/2026-09-12-essay-3bf32c8a197d2196 on 2026-09-12. If these
// tests ever fail, the module has stopped detecting the defect it was written for.
...
eq(checkVoice('In her review, Rowan rated the conference 5 out of 5 and the workshop 1.', OPTS).length, 0, 'third-person review naming Rowan passes');
...
eq(checkVoice('We sat in a circle with about forty researchers.', OPTS).map(x => x.kind), ['invented-particular', 'invented-particular'], 'headcount + scene flagged');
