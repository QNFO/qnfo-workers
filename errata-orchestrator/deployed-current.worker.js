...
var worker_default = {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/health") {
      return json({
        ok: true,
        worker: "qnfo-errata-orchestrator",
        version: VERSION,
        bindings: {
          workflow: !!env.ERRATA_WORKFLOW,
          watch: !!env.ERRATA_WATCH,
          respond: !!env.ERRATA_RESPOND,
          publish: !!env.ERRATA_PUBLISH,
...
var ErrataWorkflow = class extends WorkflowEntrypoint {
  static {
    __name(this, "ErrataWorkflow");
  }
