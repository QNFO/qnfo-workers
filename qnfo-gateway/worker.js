...
function renderHubHTML(recentPapers, paperCount, nodesCount = 0) {
  ...
  if (recentPapers && recentPapers.length > 0) {
    ...
    ).join("") + '</ul><p class="ld-more"><a href="/papers">All ' + total + " papers \u2192</a></p></section>";
  }
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>QNFO \u2014 Research Foundation</title><meta name="description" content="QNFO is an open-science research collective publishing critical analyses of the quantum computing industry \u2014 p-adic mathematics, ultrametric geometry, topological quantum computation, and the thermodynamic reality of computation. Every claim independently verifiable."><meta property="og:title" content="QNFO \u2014 Research Foundation"><meta property="og:description" content="Open-science research collective. ' + total + ` papers, independently verifiable, Zenodo DOIs."><meta property="og:type" content="website"><meta property="og:url" content="https://qnfo.org"><meta name="twitter:card" content="summary"><link rel="canonical" href="https://qnfo.org"><link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='7' fill='%2324315e'/><text x='16' y='23' text-anchor='middle' font-size='18' fill='%23faf7f2' font-family='Georgia,serif'>Q</text></svg>"><script>window.MathJax={tex:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:true},svg:{scale:1.1,fontCache:"global"},options:{skipHtmlTags:["script","noscript","style","textarea","pre","code"],enableMenu:false}};function __mq(){if(window.MathJax&&MathJax.typesetPromise){MathJax.typesetPromise().catch(function(){})}}if(document.readyState==="complete"){setTimeout(__mq,150)}else{window.addEventListener("load",function(){setTimeout(__mq,150)})}<\/script><script src="https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-svg-full.js" id="MathJax-script" onerror="this.onerror=null;var s=document.createElement('script');s.src='https://unpkg.com/mathjax@3/es5/tex-svg-full.js';document.head.appendChild(s);"><\/script><style>` + COMMON_CSS + LD_CSS + '</style><!-- Google tag (gtag.js) --><script async src="https://www.googletagmanager.com/gtag/js?id=G-LV7RHRVW6R"><\/script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag("js",new Date());gtag("config","G-LV7RHRVW6R");<\/script></head><body><a href="#ld-main" class="skip-link">Skip to main content</a><header class="ld-top"><a class="ld-brand" href="/" aria-label="QNFO home"><span class="qmark">Q</span> QNFO</a><nav class="ld-nav" aria-label="Main"><a href="/papers">Papers</a><a href="https://ideas.qnfo.org">Ideas</a><a href="https://qwav.org">QWAV</a><a href="https://ask.qwav.tech">Ask</a><a href="https://archive.qnfo.org">Archive</a><a href="/legal">License</a></nav></header><main class="ld-main" id="ld-main"><section class="ld-hero"><span class="ld-tag">Research foundation</span><h1>QNFO</h1><p>An open-science research collective publishing critical analyses of the quantum computing industry \u2014 p-adic mathematics, ultrametric geometry, topological quantum computation, and the thermodynamic reality of computation. Every claim independently verifiable.</p></section><div class="ld-cards">' + cardsHtml + "</div>" + papersHtml + '<section class="ld-sub" id="subscribe" aria-labelledby="ld-sub-h"><h2 id="ld-sub-h">New papers by email</h2><p>QNFO is moving off the social feeds. When new research is published, subscribers get one short weekly digest \u2014 titles, links and DOIs, nothing else.</p><form id="ld-sub-form" novalidate><label class="ld-sr" for="ld-email">Email address</label><input id="ld-email" type="email" name="email" placeholder="you@example.com" autocomplete="email" required><input class="ld-hp" type="text" id="ld-hp" name="website" tabindex="-1" autocomplete="off" aria-hidden="true"><button type="submit" id="ld-btn">Subscribe</button></form><p class="ld-msg" id="ld-msg" role="status" aria-live="polite"></p></section></main><footer class="ld-foot"><span>\xA9 2026 QNFO</span><a href="/papers">Papers</a><a href="/about">About</a><a href="https://qwav.org">QWAV</a><a href="/legal">QNFO-ULA</a></footer>' + formScript + "</body></html>";
}
