...
var MODELS = {
  ...
  // v4.4.0: Tier B science models per LLM audit 2026-08-13 (all verified free tier-0)
...
function autoRoute(cls) {
  ...
  return "glm-5.2"; // v4.4.0: audit 2026-08-13 default — GLM-5.2 (LiveBench math 89.8)
}
