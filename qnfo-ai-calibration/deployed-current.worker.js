    ...
    try {
      ...
      try {
        ...
        if (recurring) {
          ...
          else await env.QNFO_AUDIT.prepare("INSERT OR IGNORE INTO ai_model_health (model_id, status, updated_at) VALUES (?1,'degraded',?2)").bind(targetId, (/* @__PURE__ */ new Date()).toISOString()).run();
