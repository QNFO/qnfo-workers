var VERSION = "research-daily-brief/fabric-20260910";
...
const DAILY_KW = {
  ...
  QEC: [4, ['quantum error correction','surface code','stabilizer code','topological code','qec decoder','quantum ldpc','gkp code','concatenated code','quantum repeater','toric code','color code','bacon shor','magic state distillation','quantum darwinism','error syndrome','decoding graph']],
