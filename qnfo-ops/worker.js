...
async function handleChat(env, body, authHeader, ua, ctx) {
  ...
  const loopDeadlineMs = envInt(env, "OPS_LOOP_DEADLINE_MS", 180000); // OPS-TIME-BUDGET-1: raised 30s->180s (soft budget; see runner)
