...
| 4 | **Emergent Ventures** (Mercatus) | Zero-to-one open research infrastructure + JPCUB standard | Intro email → emergentventures@mercatus.gmu.edu (their documented application-contact address; web form has reCAPTCHA — hard wall) | HTTP 200, message `<qwuZr8OrHNpATPtrb3HFfYMHWvGHwYEcrAEF@qwav.tech>` (2026-08-13) | $25,000–30,000 | Sent — awaiting response |
...
| **Emergent Ventures web form** | reCAPTCHA — cannot be completed programmatically; email intro sent instead | None — email is the documented alternative |
